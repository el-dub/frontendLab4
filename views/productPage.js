    		...
    		<div class="row product-row">
    			...
    			<div class="col-md-6 col-12 product-info">
					...
					<div class="dp-product-block__quantity col-sm-4 col-9 col-md-6 mt-2">
						<button id="minus_product" type="button" class="dp-product-block__quantity-control">
						...
						<p id="product_quantity" class="dp-product-block__quantity-count">1</p>
						<button id="plus_product" type="button" class="dp-product-block__quantity-control">
